...
class Shop(models.Model):
    """店铺模型"""
    name = models.CharField(max_length=50, unique=True, verbose_name="店铺名称")
...
class Product(models.Model):
    ...
    chinese_name = models.CharField(max_length=200, blank=True, verbose_name="中文名称")
    ...
    def save(self, *args, **kwargs):
        ...
        # 计算总货值（确保使用Decimal进行计算）
        self.total_value = (
            Decimal(str(self.value_in_warehouse)) + 
            Decimal(str(self.value_arrived)) + 
            Decimal(str(self.value_in_transit))
